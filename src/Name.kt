...
fun main() {
    ...
    val goodass = arrayOf("Now or never", "Never look back", "Live without regrets", "Never say never", "Keep Strong", "You can do better")
    val badass = arrayOf("You are the best!", "Keep it up!", "Great job!", "Excellent result!")
